...
--INSERT INTO movies_actors (momovies_actors_id_movies_id_actorsvie_id, actor_id)
...
--    user_limit numeric NULL DEFAULT DEFAULT 1,
--    user_ids numeric(user_limit)[],
--)
--
---- Bets
