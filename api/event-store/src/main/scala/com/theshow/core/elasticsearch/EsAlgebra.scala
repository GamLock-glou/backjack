// TODO: https://www.elastic.co/guide/en/elasticsearch/client/java-api-client/current/connecting.html
        ...
        _ <- indexExit
          ...
          .ifM(
            ...
            Async[F].delay(
              ...
              .println(s"Index with the name ${esConfig.index.value} has been created 🚀")
          )
      } yield ()
